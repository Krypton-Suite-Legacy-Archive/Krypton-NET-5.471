        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if (_ribbonColorButton?.Ribbon != null)
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Color Button First", Design.Properties.Resources.MoveFirst, OnMoveFirst);
                    _movePreviousMenu = new ToolStripMenuItem("Move Color Button Previous", Design.Properties.Resources.MovePrevious, OnMovePrevious);
                    _moveNextMenu = new ToolStripMenuItem("Move Color Button Next", Design.Properties.Resources.MoveNext, OnMoveNext);
                    _moveLastMenu = new ToolStripMenuItem("Move Color Button Last", Design.Properties.Resources.MoveLast, OnMoveLast);
                    _deleteButtonMenu = new ToolStripMenuItem("Delete Color Button", Design.Properties.Resources.delete2, OnDeleteButton);
