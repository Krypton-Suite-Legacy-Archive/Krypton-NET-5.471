        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if (_ribbonTrackBar?.Ribbon != null)
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move TrackBar First", Design.Properties.Resources.MoveFirst, OnMoveFirst);
                    _movePreviousMenu = new ToolStripMenuItem("Move TrackBar Previous", Design.Properties.Resources.MovePrevious, OnMovePrevious);
                    _moveNextMenu = new ToolStripMenuItem("Move TrackBar Next", Design.Properties.Resources.MoveNext, OnMoveNext);
                    _moveLastMenu = new ToolStripMenuItem("Move TrackBar Last", Design.Properties.Resources.MoveLast, OnMoveLast);
                    _deleteTrackBarMenu = new ToolStripMenuItem("Delete TrackBar", Design.Properties.Resources.delete2, OnDeleteTrackBar);
