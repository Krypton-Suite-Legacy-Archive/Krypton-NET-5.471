        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if (_ribbonDateTimePicker?.Ribbon != null)
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move DateTimePicker First", Design.Properties.Resources.MoveFirst, OnMoveFirst);
                    _movePreviousMenu = new ToolStripMenuItem("Move DateTimePicker Previous", Design.Properties.Resources.MovePrevious, OnMovePrevious);
                    _moveNextMenu = new ToolStripMenuItem("Move DateTimePicker Next", Design.Properties.Resources.MoveNext, OnMoveNext);
                    _moveLastMenu = new ToolStripMenuItem("Move DateTimePicker Last", Design.Properties.Resources.MoveLast, OnMoveLast);
                    _deleteDateTimePickerMenu = new ToolStripMenuItem("Delete DateTimePicker", Design.Properties.Resources.delete2, OnDeleteDateTimePicker);
